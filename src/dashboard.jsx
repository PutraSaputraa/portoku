        ...
        <div>
            ...
            <section className="h-screen">
                ...
                <div className="h-1/2 relative bg-gradient-to-b from-blue-100 to-white">
                    ...
                    />
                    <h1 className="absolute bottom-40 left-2 font-poppins text-5xl font-bold text-blue-600 tracking-wider z-0">Anugraha</h1>
                ...
                <div className="h-3/4 relative bg-blue-500 flex justify-center">
                    ...
                    <img 
                        ...
                        alt="SMA7" 
                        className="h-[300px] absolute top-44 z-10 rounded-tl-[80px] rounded-br-[80px]"
                    />
